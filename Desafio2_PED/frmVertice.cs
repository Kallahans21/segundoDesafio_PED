...
namespace Desafio2_PED
{
    public partial class frmVertice : Form
    {
        ...
        public string dato;         //El dato que almacena el vertice
        ...
        {
            if (MessageBox.Show("¿Está seguro que desea salir?", "Salir", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes)
            {
                Application.Exit();
            }
        }
